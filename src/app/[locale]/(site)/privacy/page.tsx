...
export default async function Privacy({ params }: LocalePageProps) {
  const locale = await getRouteLocale(params);
  ...
  return (
    <>
      <script
        {...jsonLdScriptProps(
          buildBreadcrumbList(locale, [{ name: title, path: "/privacy" }]),
        )}
      />
      <TopPage />
  ...
  return (
    <>
      ...
      <p>
        ...
        <LocaleLink href="/imprint" className="text-green-400 hover:text-green-300">Imprint (Impressum)</LocaleLink>.
      </p>
      <p className="mt-2">
        Email:{" "}
  ...
  return (
    <>
      ...
      <p>
        ...
        <LocaleLink href="/imprint" className="text-green-400 hover:text-green-300">Impressum</LocaleLink>.
      </p>
      <p className="mt-2">
        E-Mail:{" "}
        <a href="mailto:contact@onthepixel.net" className="text-green-400 hover:text-green-300">
