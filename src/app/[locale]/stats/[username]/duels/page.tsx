...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    // The root layout's title template already appends " — OnThePixel.net".
    title: `${username} — Duels Kits`,
    description: `Detailed duels kit statistics for ${username} on OnThePixel.net.`,
    robots: { index: false, follow: true },
  };
}

// Deliberately dynamic: the username segment has an unbounded URL space and
// the page is noindex (see generateMetadata), so there is nothing to
// prerender.
