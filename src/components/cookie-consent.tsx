...
export default function CookieConsent() {
  ...
  const handleCustomize = () => {
    // This could open a more detailed modal with granular options
    // For now, we'll just show/hide the main consent
      ...
      <Card className="mx-auto max-w-3xl border-green-700/30 bg-gray-900/95 backdrop-blur shadow-lg">
        ...
        <CardContent className="text-sm text-gray-300">
          <p>
            ...
            and provide personalized content. We use Vercel Analytics to collect anonymous information about how visitors use our website.
          </p>
          <p className="mt-2">
